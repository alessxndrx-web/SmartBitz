...
const topProducts = [
  { name: 'Aceite 900ml', segment: 'Retail', sales: 'C$ 22,340', trend: '+9.4%' },
  { name: 'Arroz 25lb', segment: 'Mayorista', sales: 'C$ 18,120', trend: '+5.1%' },
  { name: 'Azúcar 1kg', segment: 'Retail', sales: 'C$ 14,470', trend: '-1.2%' },
];
      ...
      <DashboardMotion>
        <section className="command-stage motion-fade-up">
          <article className="command-hero">
            ...
            <div className="dashboard-filter-bar" role="toolbar" aria-label="Filtros del dashboard">
              <button className="filter-pill filter-pill-active" type="button">Hoy</button>
              <button className="filter-pill" type="button">7 días</button>
              <button className="filter-pill" type="button">30 días</button>
              <button className="filter-pill" type="button">Sucursal Central</button>
            </div>
          ...
          <aside className="command-rail">
            ...
            <Card className="next-actions" title="Action Panel" description="Acciones recomendadas por impacto en caja y operación.">
        ...
        <section className="ops-editorial-grid motion-fade-up">
          ...
          <div className="ops-stack">
            ...
            <Card title="Top Productos" description="Tabla operativa de rendimiento comercial." className="card-soft">
                ...
                <tbody>
                  {topProducts.map((product) => (
                    <tr key={product.name}>
                      ...
                      <td>{product.sales}</td>
                      <td className={product.trend.startsWith('-') ? 'trend-down' : 'trend-up'}>{product.trend}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <Card title="Pipeline de incidencias" description="Estado actual de incidencias operativas." className="card-soft">
              <div className="empty-state">
                <p>No hay incidencias nuevas en la última hora.</p>
                <small>El sistema está estable. Te notificaremos si surge un evento crítico.</small>
              </div>
            </Card>
